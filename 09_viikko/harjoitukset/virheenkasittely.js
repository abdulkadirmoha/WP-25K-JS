...
function parseJSON(text) {
  try {
    return JSON.parse(text); // Yritetään jäsentää JSON
  } catch (error) {
...
// Testitapaukset:
console.log(parseJSON('{"name": "Alice", "age": 25}')); // Palauttaa olion
console.log(parseJSON("Invalid JSON text")); // Tulostaa virheen ja palauttaa null
